...
public class Login extends AppCompatActivity {
    ...
    public void buLogin(View view) {
        ...
        StorageReference mountainsRef = storageRef.child("twitterImages/"+ ImagePath);
        ...
        uploadTask.addOnFailureListener(new OnFailureListener() {
            ...
            public void onFailure(@NonNull Exception exception) {
                ...
                Toast.makeText(Login.this, "Image Could not be Uploaded", Toast.LENGTH_SHORT).show();
            }
        ...
        protected void onProgressUpdate(String... progress) {
            ...
            try {
                ...
                if (json.getString("msg").equalsIgnoreCase("user is added")) {
                    ...
                    //login
                    String url="http://10.0.2.2/twitterserver/login.php?email="+etEmail.getText().toString()+"&password="+etPassword.getText().toString() ;
                ...
                if (json.getString("msg").equalsIgnoreCase("Pass Login")) {
                    ...
                    JSONObject UserCredintal= UserInfo.getJSONObject(0);
                    hideProgressDialog();
                    SaveSettings saveSettings= new SaveSettings(getApplicationContext());
                    saveSettings.SaveData(UserCredintal.getString("user_id"));
